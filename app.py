...
# nhập mô hình của chúng tôi từ thư mục
...
def login():
    if request.method == 'POST':
        ...
        if user is not None and user.password == password:
            session['name'] = user.name #lưu trữ biến trong phiên
...
if __name__ == '__main__':
    ...
    new_user = Users(username='admin', password='123456789', name='Vung')
    db.session.add(new_user)

    #new_user_2 = Users(username='levanvung', password='123456789', name='vung')
